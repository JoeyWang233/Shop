						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<c:forEach items="${orderList }" var="order" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${order.oid }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${order.total }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${order.name }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${order.state==0?"未付款":"已付款" }</td>
									<td align="center" style="HEIGHT: 22px"><input type="button" value="订单详情" class="clickedElement"
	...
	<div id="showDiv" class="blk" style="display: none;">
		<div class="main">
			...
			<div id="loading" style="padding-top: 30px; text-align: center;">
				<img alt="" style="width: 150px;height: 150px;" src="${pageContext.request.contextPath }/images/loading.gif">
			</div>
			<div style="padding: 20px;">
				<table id="showDivTab" style="width: 100%">
					...
					<%-- <tr style='text-align: center;'>
						<td><img src='${pageContext.request.contextPath }/products/1/c_0014' width='70' height='60'></td>
