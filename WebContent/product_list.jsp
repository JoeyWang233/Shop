	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.list }" var="pro">
			...
			<div class="col-md-2" style="height: 250px">
				...
				<p>
					<a href="${pageContext.request.contextPath }/product?method=productInfo&pid=${pro.pid }" style='color: green'>${pro.pname }</a>
				</p>
				<p>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				...
				<c:forEach items="${historyProductList }" var="hostoryPro">
				
					<li style="width: 150px; height: 216; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;">
						<img src="${pageContext.request.contextPath }/${hostoryPro.pimage }" width="130px" height="130px" />
					</li>
