...
<script type="text/javascript">
	...
	function(value, element, params) {
		...
		$.ajax({
			//这里要改成同步，因为$.ajax这部分代码相当于开了一个新线程，不等这部分代码就继续向下执行了。
			"async" : false,
			...
			<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				...
				<form id="myform" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/register" method="post">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio" name="sex" id="sex1" value="male">男
							</label> <label class="radio-inline"> <input type="radio" name="sex" id="sex2" value="female">女
							</label> <label class="error" for="sex" style="display: none">请选择您的性别</label>
						</div>
					</div>
					<div class="form-group">
